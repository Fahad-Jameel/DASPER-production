...
const ResultsScreen = ({ route, navigation }) => {
  ...
  const handleShareReport = async (reportId) => {
    try {
      ...
      const buildingName = assessmentData.building_info?.name || 'Unknown Building';
      const severityCategory = summary.severity_category || 'Unknown';
      const estimatedCost = summary.estimated_cost_local || 'N/A';
  ...
  const createPDFFile = async (blob) => {
    // This would implement PDF creation from blob
  ...
  const { building_info, damage_assessment, cost_estimation, ai_analysis, summary } = assessmentData;
      ...
      >
        <View style={styles.headerContent}>
          ...
          <View style={styles.headerTextContainer}>
            ...
            <Text style={styles.headerSubtitle}>{building_info?.name || 'Unknown Building'}</Text>
          </View>
      ...
      >
        ...
        >
          ...
          <View style={styles.metricsGrid}>
            ...
            <View style={styles.metricCard}>
              ...
              <Text style={styles.metricValue}>
                {cost_estimation?.formatted_cost || summary?.estimated_cost_local || '$0'}
              </Text>
        ...
        >
          ...
          <View style={styles.imagesContainer}>
            ...
            >
              <Image
                source={{ uri: `data:image/jpeg;base64,${assessmentData.images?.original || ''}` }}
            ...
            >
              <Image
                source={{ uri: `data:image/jpeg;base64,${assessmentData.images?.heatmap || ''}` }}
                style={styles.analysisImage}
              />
              <View style={styles.imageOverlay}>
        ...
        <View style={styles.modalContainer}>
          ...
          >
            <View style={styles.modalContent}>
              ...
              <Image
                source={{
                  uri: `data:image/jpeg;base64,${assessmentData.images?.[selectedImage] || ''}`
                }}
