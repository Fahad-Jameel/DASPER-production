...
class GeminiBuildingAnalyzer:
    ...
    def analyze_building_with_gemini(self, image, building_type='residential', location=None, pin_location=None):
        """
        Analyze building using Gemini Vision API for accurate height and area estimation
        ...
        Returns:
            dict: Complete analysis results with Gemini insights
        """
        try:
            ...
            # Calculate confidence based on Gemini analysis quality
            ...
            return {
                'height_analysis': {
                    ...
                    'gemini_insights': gemini_analysis.get('height_insights', ''),
                    'bounds': {
                ...
                'area_analysis': {
                    ...
                    'confidence': round(float(confidence), 3),
                    'method': 'gemini_vision_api',
                    'gemini_insights': gemini_analysis.get('area_insights', ''),
    ...
    def _analyze_with_gemini_vision(self, image, building_type, region_type, pin_location):
        ...
        try:
            ...
            logger.info(f"✅ Gemini analysis completed: {gemini_analysis}")
